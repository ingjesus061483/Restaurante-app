...
@section('title','Editar materias primas')
@section('content')  
<div class="card mb-4">
    <div class="card-body">
        @if($errors->any())
        ...
        <form action="{{url('/materiaprimas')}}/{{$materiaprima->id}}" autocomplete="off" method="post">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="nombre" value="{{$materiaprima->nombre}}" class="form-control" id="nombre">
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <select type="text" name="unidad_medida" class="form-select"
                 id="unidad_medida">
                    ...
                    <option value="{{$item->id}}"
                        @if($materiaprima->unidad_medida->id==$item->id)
                    {{'selected'}}
                    @endif
                        >{{$item->nombre}}</option>
                    @endforeach
