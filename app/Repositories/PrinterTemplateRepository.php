...
class PrinterTemplateRepository
{
    ...
    private function ImprimirPlantillaOrdenServicio(Printer $printer,$ordenservicio)
    {
        ...
        $printer->setTextSize($contenido,$contenido);
        $printer->text("Ticket No:".$ordenservicio->orden_encabezado->id."\n" );
        ...
        if($ordenservicio->orden_encabezado->mesa!=null)
        {
            $printer->text("Mesa:".$ordenservicio->orden_encabezado->mesa->nombre." ");
        }
